...
def seed_data():
    with app.app_context():
        ...
        restaurant_foods = [
            ...
            Restaurant_Food(restaurant=restaurants[0], food=foods[2]),
            Restaurant_Food(restaurant=restaurants[0], food=foods[3]),
            Restaurant_Food(restaurant=restaurants[0], food=foods[4]),
            Restaurant_Food(restaurant=restaurants[0], food=foods[5]),
            Restaurant_Food(restaurant=restaurants[0], food=foods[6]),
            Restaurant_Food(restaurant=restaurants[0], food=foods[7]),
            Restaurant_Food(restaurant=restaurants[0], food=foods[8]),
            Restaurant_Food(restaurant=restaurants[0], food=foods[9]),
            Restaurant_Food(restaurant=restaurants[1], food=foods[10]),
            Restaurant_Food(restaurant=restaurants[1], food=foods[11]),
            Restaurant_Food(restaurant=restaurants[1], food=foods[12]),
            Restaurant_Food(restaurant=restaurants[1], food=foods[13]),
            Restaurant_Food(restaurant=restaurants[1], food=foods[14]),
            Restaurant_Food(restaurant=restaurants[1], food=foods[15]),
            Restaurant_Food(restaurant=restaurants[1], food=foods[16]),
            Restaurant_Food(restaurant=restaurants[1], food=foods[17]),
            Restaurant_Food(restaurant=restaurants[1], food=foods[18]),
            Restaurant_Food(restaurant=restaurants[1], food=foods[19]),
            Restaurant_Food(restaurant=restaurants[2], food=foods[20]),
            Restaurant_Food(restaurant=restaurants[2], food=foods[21]),
            Restaurant_Food(restaurant=restaurants[2], food=foods[22]),
            Restaurant_Food(restaurant=restaurants[2], food=foods[23]),
            Restaurant_Food(restaurant=restaurants[2], food=foods[24]),
            Restaurant_Food(restaurant=restaurants[2], food=foods[25]),
            Restaurant_Food(restaurant=restaurants[2], food=foods[26]),
            Restaurant_Food(restaurant=restaurants[2], food=foods[27]),
            Restaurant_Food(restaurant=restaurants[2], food=foods[28]),
            Restaurant_Food(restaurant=restaurants[2], food=foods[29]),
            Restaurant_Food(restaurant=restaurants[3], food=foods[30]),
            Restaurant_Food(restaurant=restaurants[3], food=foods[31]),
            Restaurant_Food(restaurant=restaurants[3], food=foods[32]),
            Restaurant_Food(restaurant=restaurants[3], food=foods[33]),
            Restaurant_Food(restaurant=restaurants[3], food=foods[34]),
            Restaurant_Food(restaurant=restaurants[3], food=foods[35]),
            Restaurant_Food(restaurant=restaurants[3], food=foods[36]),
            Restaurant_Food(restaurant=restaurants[3], food=foods[37]),
            Restaurant_Food(restaurant=restaurants[3], food=foods[38]),
            Restaurant_Food(restaurant=restaurants[3], food=foods[39]),
            Restaurant_Food(restaurant=restaurants[4], food=foods[40]),
            Restaurant_Food(restaurant=restaurants[4], food=foods[41]),
            Restaurant_Food(restaurant=restaurants[4], food=foods[42]),
            Restaurant_Food(restaurant=restaurants[4], food=foods[43]),
            Restaurant_Food(restaurant=restaurants[4], food=foods[44]),
            Restaurant_Food(restaurant=restaurants[4], food=foods[45]),
            Restaurant_Food(restaurant=restaurants[4], food=foods[46]),
            Restaurant_Food(restaurant=restaurants[4], food=foods[47]),
            Restaurant_Food(restaurant=restaurants[4], food=foods[48]),
            Restaurant_Food(restaurant=restaurants[4], food=foods[49]),
            Restaurant_Food(restaurant=restaurants[5], food=foods[0]),
            Restaurant_Food(restaurant=restaurants[5], food=foods[1]),
            Restaurant_Food(restaurant=restaurants[5], food=foods[2]),
            Restaurant_Food(restaurant=restaurants[5], food=foods[3]),
            Restaurant_Food(restaurant=restaurants[5], food=foods[4]),
            Restaurant_Food(restaurant=restaurants[5], food=foods[5]),
            Restaurant_Food(restaurant=restaurants[5], food=foods[6]),
            Restaurant_Food(restaurant=restaurants[5], food=foods[7]),
            Restaurant_Food(restaurant=restaurants[5], food=foods[8]),
            Restaurant_Food(restaurant=restaurants[5], food=foods[9]),
            Restaurant_Food(restaurant=restaurants[6], food=foods[10]),
            Restaurant_Food(restaurant=restaurants[6], food=foods[11]),
            Restaurant_Food(restaurant=restaurants[6], food=foods[12]),
            Restaurant_Food(restaurant=restaurants[6], food=foods[13]),
            Restaurant_Food(restaurant=restaurants[6], food=foods[14]),
            Restaurant_Food(restaurant=restaurants[6], food=foods[15]),
            Restaurant_Food(restaurant=restaurants[6], food=foods[16]),
            Restaurant_Food(restaurant=restaurants[6], food=foods[17]),
            Restaurant_Food(restaurant=restaurants[6], food=foods[18]),
            Restaurant_Food(restaurant=restaurants[6], food=foods[19]),
            Restaurant_Food(restaurant=restaurants[7], food=foods[20]),
            Restaurant_Food(restaurant=restaurants[7], food=foods[21]),
            Restaurant_Food(restaurant=restaurants[7], food=foods[22]),
            Restaurant_Food(restaurant=restaurants[7], food=foods[23]),
            Restaurant_Food(restaurant=restaurants[7], food=foods[24]),
            Restaurant_Food(restaurant=restaurants[7], food=foods[25]),
            Restaurant_Food(restaurant=restaurants[7], food=foods[26]),
            Restaurant_Food(restaurant=restaurants[7], food=foods[27]),
            Restaurant_Food(restaurant=restaurants[7], food=foods[28]),
            Restaurant_Food(restaurant=restaurants[7], food=foods[29]),
            Restaurant_Food(restaurant=restaurants[8], food=foods[30]),
            Restaurant_Food(restaurant=restaurants[8], food=foods[31]),
            Restaurant_Food(restaurant=restaurants[8], food=foods[32]),
            Restaurant_Food(restaurant=restaurants[8], food=foods[33]),
            Restaurant_Food(restaurant=restaurants[8], food=foods[34]),
            Restaurant_Food(restaurant=restaurants[8], food=foods[35]),
            Restaurant_Food(restaurant=restaurants[8], food=foods[36]),
            Restaurant_Food(restaurant=restaurants[8], food=foods[37]),
            Restaurant_Food(restaurant=restaurants[8], food=foods[38]),
            Restaurant_Food(restaurant=restaurants[8], food=foods[39]),
            Restaurant_Food(restaurant=restaurants[9], food=foods[40]),
            Restaurant_Food(restaurant=restaurants[9], food=foods[41]),
            Restaurant_Food(restaurant=restaurants[9], food=foods[42]),
            Restaurant_Food(restaurant=restaurants[9], food=foods[43]),
            Restaurant_Food(restaurant=restaurants[9], food=foods[44]),
            Restaurant_Food(restaurant=restaurants[9], food=foods[45]),
            Restaurant_Food(restaurant=restaurants[9], food=foods[46]),
            Restaurant_Food(restaurant=restaurants[9], food=foods[47]),
            Restaurant_Food(restaurant=restaurants[9], food=foods[48]),
            Restaurant_Food(restaurant=restaurants[9], food=foods[49]),
            Restaurant_Food(restaurant=restaurants[10], food=foods[0]),
            Restaurant_Food(restaurant=restaurants[10], food=foods[12]),
            Restaurant_Food(restaurant=restaurants[10], food=foods[21]),
            Restaurant_Food(restaurant=restaurants[10], food=foods[31]),
            Restaurant_Food(restaurant=restaurants[10], food=foods[41]),
            Restaurant_Food(restaurant=restaurants[10], food=foods[5]),
            Restaurant_Food(restaurant=restaurants[10], food=foods[18]),
            Restaurant_Food(restaurant=restaurants[10], food=foods[23]),
            Restaurant_Food(restaurant=restaurants[10], food=foods[39]),
            Restaurant_Food(restaurant=restaurants[10], food=foods[43]),
            Restaurant_Food(restaurant=restaurants[11], food=foods[8]),
            Restaurant_Food(restaurant=restaurants[11], food=foods[16]),
            Restaurant_Food(restaurant=restaurants[11], food=foods[19]),
            Restaurant_Food(restaurant=restaurants[11], food=foods[24]),
            Restaurant_Food(restaurant=restaurants[11], food=foods[48]),
            Restaurant_Food(restaurant=restaurants[11], food=foods[1]),
            Restaurant_Food(restaurant=restaurants[11], food=foods[34]),
            Restaurant_Food(restaurant=restaurants[11], food=foods[39]),
            Restaurant_Food(restaurant=restaurants[11], food=foods[42]),
            Restaurant_Food(restaurant=restaurants[11], food=foods[28])
        ]
